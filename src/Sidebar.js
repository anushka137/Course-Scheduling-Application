    ...
    return (
      <>
        <Card style={{ backgroundColor: "Coral", width: 'calc(20vw - 5px)', marginLeft: '5px', height: 'calc(100vh - 10px)', position: 'fixed' }}>
          <Card.Body>
            <Form>
              <Form.Group controlId="formKeywords" onChange={() => this.setCourses()} class="mb-5" style={{ width: '100%' }}>
                <Form.Label style={{ fontSize: 20, fontWeight: 'bold', fontFamily: 'Montserrat' }}>Search</Form.Label>
                <Form.Control type="text" id="input" placeholder="Search" autoComplete="off" ref={this.search} />
              </Form.Group>
              <Form.Group controlId="formSubject" class="mb-5">
                <Form.Label style={{ fontSize: 20, fontWeight: 'bold', fontFamily: 'Montserrat' }}>Subject</Form.Label>
              ...
              <div style={{ display: 'flex', flexDirection: 'row' }}>
                <Form.Group controlId="minimumCredits" onChange={() => this.setCourses()} onKeyDown={(e) => this.handleCreditsKeyDown(e)}>
                  <Form.Label style={{ fontSize: 20, fontWeight: 'bold', fontFamily: 'Montserrat' }}>Credits</Form.Label>
                  <Form.Control type="text" id="input" placeholder="Minimum" autoComplete="off" ref={this.minimumCredits} />
                </Form.Group>
                <div style={{ fontSize: 20, fontWeight: 'bold', fontFamily: 'Montserrat', marginLeft: '5px', marginRight: '5px', marginTop: '38px' }}>to</div>
                <Form.Group controlId="maximumCredits" style={{ marginTop: '32px' }} onChange={() => this.setCourses()} onKeyDown={(e) => this.handleCreditsKeyDown(e)}>
                  <Form.Control type="text" id="input" placeholder="Maximum" autoComplete="off" ref={this.maximumCredits} />
                </Form.Group>
              </div>
            </Form>
          </Card.Body>
